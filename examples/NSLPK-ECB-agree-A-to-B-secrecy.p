...
fof(ax331, axiom,
![VAR_0X40SID_394, VAR_SIGN_I_PKI_393] : ((pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_393, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_393)) => pred_attacker(tuple_2(constr_ecb_enc_2(name_Na(VAR_0X40SID_394), name_A, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_393, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax332, axiom,
![VAR_0X40SID_465, VAR_ECB_ENC_NA_NI_I_464, VAR_SIGN_I_PKI_466] : ((pred_eq(name_I, constr_tuple_3_get_2(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_464, name_skA))) & pred_eq(name_Na(VAR_0X40SID_465), constr_tuple_3_get_0x30(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_464, name_skA))) & pred_attacker(VAR_ECB_ENC_NA_NI_I_464) & pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_466, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_466)) => pred_attacker(tuple_2(constr_ecb_enc_1(constr_tuple_3_get_1(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_464, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_466, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax333, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax334, axiom,
![VAR_0X40SID_591, VAR_ECB_ENC_NA_A_589, VAR_SIGN_A_PKA_590X30] : ((pred_eq(name_A, constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_589, name_skB))) & pred_attacker(VAR_ECB_ENC_NA_A_589) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_590X30, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_590X30)) => pred_attacker(tuple_2(constr_ecb_enc_3(constr_tuple_2_get_0x30(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_589, name_skB)), name_Nb(VAR_0X40SID_591), name_B, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_590X30, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax335, axiom,
![VAR_0X40SID_627, VAR_ECB_ENC_NA_A_629, VAR_ECB_ENC_NB_628, VAR_SIGN_A_PKA_630X30] : ((pred_eq(name_Nb(VAR_0X40SID_627), constr_ecb_dec_1(VAR_ECB_ENC_NB_628, name_skB)) & pred_attacker(VAR_ECB_ENC_NB_628) & pred_eq(name_A, constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_629, name_skB))) & pred_attacker(VAR_ECB_ENC_NA_A_629) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_630X30, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_630X30)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax336, axiom,
