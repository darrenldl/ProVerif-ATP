...
fof(ax268, axiom,
![VAR_X_61] : (pred_eq(VAR_X_61, VAR_X_61))).
fof(ax269, axiom,
![VAR_V_67] : (pred_attacker(VAR_V_67) => pred_attacker(constr_tuple_3_get_2(VAR_V_67)))).
fof(ax270, axiom,
![VAR_V_69] : (pred_attacker(VAR_V_69) => pred_attacker(constr_tuple_3_get_1(VAR_V_69)))).
fof(ax271, axiom,
![VAR_V_71] : (pred_attacker(VAR_V_71) => pred_attacker(constr_tuple_3_get_0x30(VAR_V_71)))).
fof(ax272, axiom,
![VAR_V_73] : (pred_attacker(VAR_V_73) => pred_attacker(constr_tuple_2_get_1(VAR_V_73)))).
fof(ax273, axiom,
![VAR_V_75] : (pred_attacker(VAR_V_75) => pred_attacker(constr_tuple_2_get_0x30(VAR_V_75)))).
fof(ax274, axiom,
pred_attacker(tuple_true)).
fof(ax275, axiom,
![VAR_V_78, VAR_V_79] : ((pred_attacker(VAR_V_78) & pred_attacker(VAR_V_79)) => pred_attacker(constr_sign(VAR_V_78, VAR_V_79)))).
fof(ax276, axiom,
![VAR_V_81] : (pred_attacker(VAR_V_81) => pred_attacker(constr_pkey(VAR_V_81)))).
fof(ax277, axiom,
pred_attacker(constr_key_retrieval_server_STEP_1)).
fof(ax278, axiom,
![VAR_V_84] : (pred_attacker(VAR_V_84) => pred_attacker(constr_getmess(VAR_V_84)))).
fof(ax279, axiom,
pred_attacker(tuple_false)).
fof(ax280, axiom,
![VAR_V_87, VAR_V_88] : ((pred_attacker(VAR_V_87) & pred_attacker(VAR_V_88)) => pred_attacker(constr_enc(VAR_V_87, VAR_V_88)))).
fof(ax281, axiom,
![VAR_V_94, VAR_V_95, VAR_V_96, VAR_V_97, VAR_V_98] : ((pred_attacker(VAR_V_94) & pred_attacker(VAR_V_95) & pred_attacker(VAR_V_96) & pred_attacker(VAR_V_97) & pred_attacker(VAR_V_98)) => pred_attacker(constr_ecb_enc_4(VAR_V_94, VAR_V_95, VAR_V_96, VAR_V_97, VAR_V_98)))).
fof(ax282, axiom,
![VAR_V_10X303, VAR_V_10X304, VAR_V_10X305, VAR_V_10X306] : ((pred_attacker(VAR_V_10X303) & pred_attacker(VAR_V_10X304) & pred_attacker(VAR_V_10X305) & pred_attacker(VAR_V_10X306)) => pred_attacker(constr_ecb_enc_3(VAR_V_10X303, VAR_V_10X304, VAR_V_10X305, VAR_V_10X306)))).
fof(ax283, axiom,
![VAR_V_110X30, VAR_V_111, VAR_V_112] : ((pred_attacker(VAR_V_110X30) & pred_attacker(VAR_V_111) & pred_attacker(VAR_V_112)) => pred_attacker(constr_ecb_enc_2(VAR_V_110X30, VAR_V_111, VAR_V_112)))).
fof(ax284, axiom,
![VAR_V_115, VAR_V_116] : ((pred_attacker(VAR_V_115) & pred_attacker(VAR_V_116)) => pred_attacker(constr_ecb_enc_1(VAR_V_115, VAR_V_116)))).
fof(ax285, axiom,
![VAR_V_119, VAR_V_120X30] : ((pred_attacker(VAR_V_119) & pred_attacker(VAR_V_120X30)) => pred_attacker(constr_ecb_dec_4(VAR_V_119, VAR_V_120X30)))).
fof(ax286, axiom,
![VAR_V_123, VAR_V_124] : ((pred_attacker(VAR_V_123) & pred_attacker(VAR_V_124)) => pred_attacker(constr_ecb_dec_3(VAR_V_123, VAR_V_124)))).
fof(ax287, axiom,
![VAR_V_127, VAR_V_128] : ((pred_attacker(VAR_V_127) & pred_attacker(VAR_V_128)) => pred_attacker(constr_ecb_dec_2(VAR_V_127, VAR_V_128)))).
fof(ax288, axiom,
![VAR_V_131, VAR_V_132] : ((pred_attacker(VAR_V_131) & pred_attacker(VAR_V_132)) => pred_attacker(constr_ecb_dec_1(VAR_V_131, VAR_V_132)))).
fof(ax289, axiom,
...
fof(ax296, axiom,
![VAR_V_139, VAR_V_140X30] : ((pred_attacker(VAR_V_139) & pred_attacker(VAR_V_140X30)) => pred_attacker(constr_checksign(VAR_V_139, VAR_V_140X30)))).
fof(ax297, axiom,
...
fof(ax305, axiom,
![VAR_V_149, VAR_V_150X30, VAR_V_151, VAR_V_152] : ((pred_attacker(VAR_V_149) & pred_attacker(VAR_V_150X30) & pred_attacker(VAR_V_151) & pred_attacker(VAR_V_152)) => pred_attacker(tuple_4(VAR_V_149, VAR_V_150X30, VAR_V_151, VAR_V_152)))).
fof(ax306, axiom,
![VAR_V_173, VAR_V_174, VAR_V_175, VAR_V_176] : (pred_attacker(tuple_4(VAR_V_173, VAR_V_174, VAR_V_175, VAR_V_176)) => pred_attacker(VAR_V_173))).
fof(ax307, axiom,
![VAR_V_178, VAR_V_179, VAR_V_180X30, VAR_V_181] : (pred_attacker(tuple_4(VAR_V_178, VAR_V_179, VAR_V_180X30, VAR_V_181)) => pred_attacker(VAR_V_179))).
fof(ax308, axiom,
![VAR_V_183, VAR_V_184, VAR_V_185, VAR_V_186] : (pred_attacker(tuple_4(VAR_V_183, VAR_V_184, VAR_V_185, VAR_V_186)) => pred_attacker(VAR_V_185))).
fof(ax309, axiom,
![VAR_V_188, VAR_V_189, VAR_V_190X30, VAR_V_191] : (pred_attacker(tuple_4(VAR_V_188, VAR_V_189, VAR_V_190X30, VAR_V_191)) => pred_attacker(VAR_V_191))).
fof(ax310, axiom,
![VAR_V_196, VAR_V_197, VAR_V_198] : ((pred_attacker(VAR_V_196) & pred_attacker(VAR_V_197) & pred_attacker(VAR_V_198)) => pred_attacker(tuple_3(VAR_V_196, VAR_V_197, VAR_V_198)))).
fof(ax311, axiom,
![VAR_V_211, VAR_V_212, VAR_V_213] : (pred_attacker(tuple_3(VAR_V_211, VAR_V_212, VAR_V_213)) => pred_attacker(VAR_V_211))).
fof(ax312, axiom,
![VAR_V_215, VAR_V_216, VAR_V_217] : (pred_attacker(tuple_3(VAR_V_215, VAR_V_216, VAR_V_217)) => pred_attacker(VAR_V_216))).
fof(ax313, axiom,
![VAR_V_219, VAR_V_220X30, VAR_V_221] : (pred_attacker(tuple_3(VAR_V_219, VAR_V_220X30, VAR_V_221)) => pred_attacker(VAR_V_221))).
fof(ax314, axiom,
![VAR_V_225, VAR_V_226] : ((pred_attacker(VAR_V_225) & pred_attacker(VAR_V_226)) => pred_attacker(tuple_2(VAR_V_225, VAR_V_226)))).
fof(ax315, axiom,
![VAR_V_233, VAR_V_234] : (pred_attacker(tuple_2(VAR_V_233, VAR_V_234)) => pred_attacker(VAR_V_233))).
fof(ax316, axiom,
![VAR_V_236, VAR_V_237] : (pred_attacker(tuple_2(VAR_V_236, VAR_V_237)) => pred_attacker(VAR_V_237))).
fof(ax317, axiom,
![VAR_V_239, VAR_V_240X30] : ((pred_mess(VAR_V_240X30, VAR_V_239) & pred_attacker(VAR_V_240X30)) => pred_attacker(VAR_V_239))).
fof(ax318, axiom,
![VAR_V_241, VAR_V_242] : ((pred_attacker(VAR_V_242) & pred_attacker(VAR_V_241)) => pred_mess(VAR_V_242, VAR_V_241))).
fof(ax319, axiom,
...
fof(ax323, axiom,
![VAR_V_244] : (pred_equal(VAR_V_244, VAR_V_244))).
fof(ax324, axiom,
![VAR_V_245] : (pred_attacker(name_new0x2Dname(VAR_V_245)))).
fof(ax325, axiom,
...
fof(ax331, axiom,
![VAR_0X40SID_393, VAR_SIGN_I_PKI_392] : ((pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_392, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_392)) => pred_attacker(tuple_2(constr_ecb_enc_2(name_Na(VAR_0X40SID_393), name_A, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_392, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax332, axiom,
![VAR_0X40SID_464, VAR_ECB_ENC_NA_NI_I_463, VAR_SIGN_I_PKI_465] : ((pred_eq(name_I, constr_tuple_3_get_2(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA))) & pred_eq(name_Na(VAR_0X40SID_464), constr_tuple_3_get_0x30(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA))) & pred_attacker(VAR_ECB_ENC_NA_NI_I_463) & pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_465, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_465)) => pred_attacker(tuple_2(constr_ecb_enc_1(constr_tuple_3_get_1(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_465, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax333, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax334, axiom,
![VAR_0X40SID_590X30, VAR_ECB_ENC_NA_A_588, VAR_SIGN_A_PKA_589] : ((pred_eq(name_A, constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_588, name_skB))) & pred_attacker(VAR_ECB_ENC_NA_A_588) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_589, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_589)) => pred_attacker(tuple_2(constr_ecb_enc_3(constr_tuple_2_get_0x30(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_588, name_skB)), name_Nb(VAR_0X40SID_590X30), name_B, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_589, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax335, axiom,
![VAR_0X40SID_626, VAR_ECB_ENC_NA_A_628, VAR_ECB_ENC_NB_627, VAR_SIGN_A_PKA_629] : ((pred_eq(name_Nb(VAR_0X40SID_626), constr_ecb_dec_1(VAR_ECB_ENC_NB_627, name_skB)) & pred_attacker(VAR_ECB_ENC_NB_627) & pred_eq(name_A, constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_628, name_skB))) & pred_attacker(VAR_ECB_ENC_NA_A_628) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_629, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_629)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax336, axiom,
![VAR_DST_674, VAR_PKDST_675, VAR_SRC_676] : ((pred_table(tuple_keys(VAR_DST_674, VAR_PKDST_675)) & pred_attacker(tuple_2(VAR_SRC_676, VAR_DST_674))) => pred_attacker(tuple_2(constr_sign(tuple_2(VAR_DST_674, VAR_PKDST_675), name_skS), constr_key_retrieval_server_STEP_1)))).
fof(ax337, axiom,
![VAR_HOST_730X30, VAR_PK_731] : ((VAR_HOST_730X30 != name_B & VAR_HOST_730X30 != name_A & pred_attacker(tuple_2(VAR_HOST_730X30, VAR_PK_731))) => pred_table(tuple_keys(VAR_HOST_730X30, VAR_PK_731)))).
fof(co0, conjecture,
