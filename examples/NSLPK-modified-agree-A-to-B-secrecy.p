...
fof(ax312, axiom,
![VAR_0X40SID_273, VAR_SIGN_I_PKI_272] : ((pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_272, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_272)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(name_Na(VAR_0X40SID_273), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_272, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax313, axiom,
![VAR_0X40SID_350X30, VAR_AENC_NA_NI_I_349, VAR_SIGN_I_PKI_351] : ((pred_eq(constr_assoc_pair_2_get_1(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_349, name_skA))), name_I) & pred_eq(constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_NI_I_349, name_skA)), name_Na(VAR_0X40SID_350X30)) & pred_attacker(VAR_AENC_NA_NI_I_349) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_351, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_351)) => pred_attacker(tuple_2(constr_aenc(constr_assoc_pair_2_get_0x30(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_349, name_skA))), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_351, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax314, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax315, axiom,
![VAR_0X40SID_484, VAR_AENC_NA_A_482, VAR_SIGN_A_PKA_483] : ((pred_eq(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_482, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_482) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_483, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_483)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_A_482, name_skB)), tuple_assoc_pair(name_Nb(VAR_0X40SID_484), name_B)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_483, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax316, axiom,
![VAR_0X40SID_515, VAR_AENC_NA_A_516, VAR_AENC_NB_514, VAR_SIGN_A_PKA_517] : ((pred_eq(constr_adec(VAR_AENC_NB_514, name_skB), name_Nb(VAR_0X40SID_515)) & pred_attacker(VAR_AENC_NB_514) & pred_eq(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_516, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_516) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_517, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_517)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax317, axiom,
