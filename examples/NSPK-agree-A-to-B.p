...
fof(ax304, axiom,
![VAR_0X40SID_247, VAR_SIGN_I_PKI_246] : ((pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_246, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_246)) => pred_attacker(tuple_2(constr_aenc(tuple_2(name_Na(VAR_0X40SID_247), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_246, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax305, axiom,
![VAR_0X40SID_30X301, VAR_AENC_NA_NI_30X302, VAR_SIGN_I_PKI_30X303] : ((pred_eq(name_Na(VAR_0X40SID_30X301), constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_NI_30X302, name_skA))) & pred_attacker(VAR_AENC_NA_NI_30X302) & pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_30X303, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_30X303)) => pred_attacker(tuple_2(constr_aenc(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_NI_30X302, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_30X303, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax306, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax307, axiom,
![VAR_0X40SID_426, VAR_AENC_NA_A_424, VAR_SIGN_A_PKA_425] : ((pred_eq(name_A, constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_424, name_skB))) & pred_attacker(VAR_AENC_NA_A_424) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_425, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_425)) => pred_attacker(tuple_2(constr_aenc(tuple_2(constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_A_424, name_skB)), name_Nb(VAR_0X40SID_426)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_425, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax308, axiom,
![VAR_0X40SID_454, VAR_AENC_NA_A_456, VAR_AENC_NB_455, VAR_SIGN_A_PKA_457] : ((pred_eq(name_Nb(VAR_0X40SID_454), constr_adec(VAR_AENC_NB_455, name_skB)) & pred_attacker(VAR_AENC_NB_455) & pred_eq(name_A, constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_456, name_skB))) & pred_attacker(VAR_AENC_NA_A_456) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_457, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_457)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax309, axiom,
