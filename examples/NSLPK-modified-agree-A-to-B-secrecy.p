...
fof(ax257, axiom,
![VAR_X_13, VAR_Y_0X30, VAR_Z_0X30] : (tuple_assoc_pair(VAR_X_13, tuple_assoc_pair(VAR_Y_0X30, VAR_Z_0X30)) = tuple_assoc_pair(tuple_assoc_pair(VAR_X_13, VAR_Y_0X30), VAR_Z_0X30))).
fof(ax258, axiom,
...
fof(ax266, axiom,
![VAR_V_48, VAR_V_49] : ((pred_attacker(VAR_V_48) & pred_attacker(VAR_V_49)) => pred_attacker(constr_sign(VAR_V_48, VAR_V_49)))).
fof(ax267, axiom,
![VAR_V_51] : (pred_attacker(VAR_V_51) => pred_attacker(constr_pkey(VAR_V_51)))).
fof(ax268, axiom,
pred_attacker(constr_key_retrieval_server_STEP_1)).
fof(ax269, axiom,
![VAR_V_54] : (pred_attacker(VAR_V_54) => pred_attacker(constr_getmess(VAR_V_54)))).
fof(ax270, axiom,
pred_attacker(tuple_false)).
fof(ax271, axiom,
![VAR_V_57, VAR_V_58] : ((pred_attacker(VAR_V_57) & pred_attacker(VAR_V_58)) => pred_attacker(constr_enc(VAR_V_57, VAR_V_58)))).
fof(ax272, axiom,
![VAR_V_61, VAR_V_62] : ((pred_attacker(VAR_V_61) & pred_attacker(VAR_V_62)) => pred_attacker(constr_dec(VAR_V_61, VAR_V_62)))).
fof(ax273, axiom,
...
fof(ax279, axiom,
![VAR_V_65, VAR_V_66] : ((pred_attacker(VAR_V_65) & pred_attacker(VAR_V_66)) => pred_attacker(constr_checksign(VAR_V_65, VAR_V_66)))).
fof(ax280, axiom,
![VAR_V_68] : (pred_attacker(VAR_V_68) => pred_attacker(constr_assoc_pair_2_get_1(VAR_V_68)))).
fof(ax281, axiom,
![VAR_V_70X30] : (pred_attacker(VAR_V_70X30) => pred_attacker(constr_assoc_pair_2_get_0x30(VAR_V_70X30)))).
fof(ax282, axiom,
![VAR_V_73, VAR_V_74] : ((pred_attacker(VAR_V_73) & pred_attacker(VAR_V_74)) => pred_attacker(tuple_assoc_pair(VAR_V_73, VAR_V_74)))).
fof(ax283, axiom,
![VAR_V_81, VAR_V_82] : (pred_attacker(tuple_assoc_pair(VAR_V_81, VAR_V_82)) => pred_attacker(VAR_V_81))).
fof(ax284, axiom,
![VAR_V_84, VAR_V_85] : (pred_attacker(tuple_assoc_pair(VAR_V_84, VAR_V_85)) => pred_attacker(VAR_V_85))).
fof(ax285, axiom,
![VAR_V_89, VAR_V_90X30] : ((pred_attacker(VAR_V_89) & pred_attacker(VAR_V_90X30)) => pred_attacker(constr_aenc(VAR_V_89, VAR_V_90X30)))).
fof(ax286, axiom,
![VAR_V_93, VAR_V_94] : ((pred_attacker(VAR_V_93) & pred_attacker(VAR_V_94)) => pred_attacker(constr_adec(VAR_V_93, VAR_V_94)))).
fof(ax287, axiom,
...
fof(ax295, axiom,
![VAR_V_10X301, VAR_V_10X302] : ((pred_attacker(VAR_V_10X301) & pred_attacker(VAR_V_10X302)) => pred_attacker(tuple_2(VAR_V_10X301, VAR_V_10X302)))).
fof(ax296, axiom,
![VAR_V_10X309, VAR_V_110X30] : (pred_attacker(tuple_2(VAR_V_10X309, VAR_V_110X30)) => pred_attacker(VAR_V_10X309))).
fof(ax297, axiom,
![VAR_V_112, VAR_V_113] : (pred_attacker(tuple_2(VAR_V_112, VAR_V_113)) => pred_attacker(VAR_V_113))).
fof(ax298, axiom,
![VAR_V_115, VAR_V_116] : ((pred_mess(VAR_V_116, VAR_V_115) & pred_attacker(VAR_V_116)) => pred_attacker(VAR_V_115))).
fof(ax299, axiom,
![VAR_V_117, VAR_V_118] : ((pred_attacker(VAR_V_118) & pred_attacker(VAR_V_117)) => pred_mess(VAR_V_118, VAR_V_117))).
fof(ax300, axiom,
...
fof(ax304, axiom,
![VAR_V_120X30] : (pred_equal(VAR_V_120X30, VAR_V_120X30))).
fof(ax305, axiom,
![VAR_V_121] : (pred_attacker(name_new0x2Dname(VAR_V_121)))).
fof(ax306, axiom,
...
fof(ax312, axiom,
![VAR_0X40SID_273, VAR_SIGN_I_PKI_272] : ((pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_272, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_272)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(name_Na(VAR_0X40SID_273), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_272, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax313, axiom,
![VAR_0X40SID_350X30, VAR_AENC_NA_NI_I_349, VAR_SIGN_I_PKI_351] : ((pred_eq(name_I, constr_assoc_pair_2_get_1(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_349, name_skA)))) & pred_eq(name_Na(VAR_0X40SID_350X30), constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_NI_I_349, name_skA))) & pred_attacker(VAR_AENC_NA_NI_I_349) & pred_eq(name_I, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_351, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_I_PKI_351)) => pred_attacker(tuple_2(constr_aenc(constr_assoc_pair_2_get_0x30(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_349, name_skA))), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_351, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax314, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax315, axiom,
![VAR_0X40SID_484, VAR_AENC_NA_A_482, VAR_SIGN_A_PKA_483] : ((pred_eq(name_A, constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_482, name_skB))) & pred_attacker(VAR_AENC_NA_A_482) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_483, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_483)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_A_482, name_skB)), tuple_assoc_pair(name_Nb(VAR_0X40SID_484), name_B)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_483, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax316, axiom,
![VAR_0X40SID_514, VAR_AENC_NA_A_516, VAR_AENC_NB_515, VAR_SIGN_A_PKA_517] : ((pred_eq(name_Nb(VAR_0X40SID_514), constr_adec(VAR_AENC_NB_515, name_skB)) & pred_attacker(VAR_AENC_NB_515) & pred_eq(name_A, constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_516, name_skB))) & pred_attacker(VAR_AENC_NA_A_516) & pred_eq(name_A, constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_517, constr_pkey(name_skS)))) & pred_attacker(VAR_SIGN_A_PKA_517)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax317, axiom,
![VAR_DST_562, VAR_PKDST_563, VAR_SRC_564] : ((pred_table(tuple_keys(VAR_DST_562, VAR_PKDST_563)) & pred_attacker(tuple_2(VAR_SRC_564, VAR_DST_562))) => pred_attacker(tuple_2(constr_sign(tuple_2(VAR_DST_562, VAR_PKDST_563), name_skS), constr_key_retrieval_server_STEP_1)))).
fof(ax318, axiom,
![VAR_HOST_618, VAR_PK_619] : ((VAR_HOST_618 != name_B & VAR_HOST_618 != name_A & pred_attacker(tuple_2(VAR_HOST_618, VAR_PK_619))) => pred_table(tuple_keys(VAR_HOST_618, VAR_PK_619)))).
fof(co0, conjecture,
pred_attacker(tuple_2(name_Nb(VAR_V_627), name_objective))).
