  ...
  let rec vampire_file_reader () =
    ...
    ( match Vampire.process_string input with
      ...
      | Ok node_map ->
         ...
         * |> ignore; *)
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"446" ~base_id:"880"
          ~result_id:"32540" node_map
        |> ignore;
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"407" ~base_id:"448"
          ~result_id:"880" node_map
        |> ignore;
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"323" ~base_id:"361"
          ~result_id:"448" node_map
        |> ignore;
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"309" ~base_id:"344"
          ~result_id:"446" node_map
        |> ignore;
        Vampire.resolve_vars_in_split ~base_id:"352" ~result_id:"361" node_map
        |> ignore;
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"299" ~base_id:"351"
          ~result_id:"352" node_map
        |> ignore;
        Vampire.resolve_vars_in_knowledge_nodes ~agent_id:"299" ~base_id:"341"
