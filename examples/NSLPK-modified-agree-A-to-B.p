...
fof(ax263, axiom,
![VAR_V_42] : (pred_attacker(VAR_V_42) => pred_attacker(constr_tuple_2_get_1(VAR_V_42)))).
fof(ax264, axiom,
![VAR_V_44] : (pred_attacker(VAR_V_44) => pred_attacker(constr_tuple_2_get_0x30(VAR_V_44)))).
fof(ax265, axiom,
pred_attacker(tuple_true)).
fof(ax266, axiom,
![VAR_V_47, VAR_V_48] : ((pred_attacker(VAR_V_47) & pred_attacker(VAR_V_48)) => pred_attacker(constr_sign(VAR_V_47, VAR_V_48)))).
fof(ax267, axiom,
![VAR_V_50X30] : (pred_attacker(VAR_V_50X30) => pred_attacker(constr_pkey(VAR_V_50X30)))).
fof(ax268, axiom,
pred_attacker(constr_key_retrieval_server_STEP_1)).
fof(ax269, axiom,
![VAR_V_53] : (pred_attacker(VAR_V_53) => pred_attacker(constr_getmess(VAR_V_53)))).
fof(ax270, axiom,
pred_attacker(tuple_false)).
fof(ax271, axiom,
![VAR_V_56, VAR_V_57] : ((pred_attacker(VAR_V_56) & pred_attacker(VAR_V_57)) => pred_attacker(constr_enc(VAR_V_56, VAR_V_57)))).
fof(ax272, axiom,
![VAR_V_60X30, VAR_V_61] : ((pred_attacker(VAR_V_60X30) & pred_attacker(VAR_V_61)) => pred_attacker(constr_dec(VAR_V_60X30, VAR_V_61)))).
fof(ax273, axiom,
...
fof(ax279, axiom,
![VAR_V_64, VAR_V_65] : ((pred_attacker(VAR_V_64) & pred_attacker(VAR_V_65)) => pred_attacker(constr_checksign(VAR_V_64, VAR_V_65)))).
fof(ax280, axiom,
![VAR_V_67] : (pred_attacker(VAR_V_67) => pred_attacker(constr_assoc_pair_2_get_1(VAR_V_67)))).
fof(ax281, axiom,
![VAR_V_69] : (pred_attacker(VAR_V_69) => pred_attacker(constr_assoc_pair_2_get_0x30(VAR_V_69)))).
fof(ax282, axiom,
![VAR_V_72, VAR_V_73] : ((pred_attacker(VAR_V_72) & pred_attacker(VAR_V_73)) => pred_attacker(tuple_assoc_pair(VAR_V_72, VAR_V_73)))).
fof(ax283, axiom,
![VAR_V_80X30, VAR_V_81] : (pred_attacker(tuple_assoc_pair(VAR_V_80X30, VAR_V_81)) => pred_attacker(VAR_V_80X30))).
fof(ax284, axiom,
![VAR_V_83, VAR_V_84] : (pred_attacker(tuple_assoc_pair(VAR_V_83, VAR_V_84)) => pred_attacker(VAR_V_84))).
fof(ax285, axiom,
![VAR_V_88, VAR_V_89] : ((pred_attacker(VAR_V_88) & pred_attacker(VAR_V_89)) => pred_attacker(constr_aenc(VAR_V_88, VAR_V_89)))).
fof(ax286, axiom,
![VAR_V_92, VAR_V_93] : ((pred_attacker(VAR_V_92) & pred_attacker(VAR_V_93)) => pred_attacker(constr_adec(VAR_V_92, VAR_V_93)))).
fof(ax287, axiom,
...
fof(ax298, axiom,
![VAR_V_114, VAR_V_115] : ((pred_mess(VAR_V_115, VAR_V_114) & pred_attacker(VAR_V_115)) => pred_attacker(VAR_V_114))).
fof(ax299, axiom,
![VAR_V_116, VAR_V_117] : ((pred_attacker(VAR_V_117) & pred_attacker(VAR_V_116)) => pred_mess(VAR_V_117, VAR_V_116))).
fof(ax300, axiom,
...
fof(ax304, axiom,
![VAR_V_119] : (pred_equal(VAR_V_119, VAR_V_119))).
fof(ax305, axiom,
![VAR_V_120X30] : (pred_attacker(name_new0x2Dname(VAR_V_120X30)))).
fof(ax306, axiom,
...
fof(ax312, axiom,
![VAR_0X40SID_272, VAR_SIGN_I_PKI_271] : ((pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_271, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_271)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(name_Na(VAR_0X40SID_272), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_271, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax313, axiom,
![VAR_0X40SID_349, VAR_AENC_NA_NI_I_348, VAR_SIGN_I_PKI_350X30] : ((pred_eq(constr_assoc_pair_2_get_1(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_348, name_skA))), name_I) & pred_eq(constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_NI_I_348, name_skA)), name_Na(VAR_0X40SID_349)) & pred_attacker(VAR_AENC_NA_NI_I_348) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_350X30, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_350X30)) => pred_attacker(tuple_2(constr_aenc(constr_assoc_pair_2_get_0x30(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_NI_I_348, name_skA))), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_350X30, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax314, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax315, axiom,
![VAR_0X40SID_483, VAR_AENC_NA_A_481, VAR_SIGN_A_PKA_482] : ((pred_eq(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_481, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_481) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_482, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_482)) => pred_attacker(tuple_2(constr_aenc(tuple_assoc_pair(constr_assoc_pair_2_get_0x30(constr_adec(VAR_AENC_NA_A_481, name_skB)), tuple_assoc_pair(name_Nb(VAR_0X40SID_483), name_B)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_482, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax316, axiom,
![VAR_0X40SID_514, VAR_AENC_NA_A_515, VAR_AENC_NB_513, VAR_SIGN_A_PKA_516] : ((pred_eq(constr_adec(VAR_AENC_NB_513, name_skB), name_Nb(VAR_0X40SID_514)) & pred_attacker(VAR_AENC_NB_513) & pred_eq(constr_assoc_pair_2_get_1(constr_adec(VAR_AENC_NA_A_515, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_515) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_516, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_516)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax317, axiom,
![VAR_DST_561, VAR_PKDST_562, VAR_SRC_563] : ((pred_table(tuple_keys(VAR_DST_561, VAR_PKDST_562)) & pred_attacker(tuple_2(VAR_SRC_563, VAR_DST_561))) => pred_attacker(tuple_2(constr_sign(tuple_2(VAR_DST_561, VAR_PKDST_562), name_skS), constr_key_retrieval_server_STEP_1)))).
fof(ax318, axiom,
![VAR_HOST_617, VAR_PK_618] : ((VAR_HOST_617 != name_B & VAR_HOST_617 != name_A & pred_attacker(tuple_2(VAR_HOST_617, VAR_PK_618))) => pred_table(tuple_keys(VAR_HOST_617, VAR_PK_618)))).
fof(co0, conjecture,
