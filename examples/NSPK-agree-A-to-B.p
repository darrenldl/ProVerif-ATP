...
fof(ax263, axiom,
![VAR_V_42, VAR_V_43] : ((pred_attacker(VAR_V_42) & pred_attacker(VAR_V_43)) => pred_attacker(constr_sign(VAR_V_42, VAR_V_43)))).
fof(ax264, axiom,
![VAR_V_45] : (pred_attacker(VAR_V_45) => pred_attacker(constr_pkey(VAR_V_45)))).
fof(ax265, axiom,
pred_attacker(constr_key_retrieval_server_STEP_1)).
fof(ax266, axiom,
![VAR_V_48] : (pred_attacker(VAR_V_48) => pred_attacker(constr_getmess(VAR_V_48)))).
fof(ax267, axiom,
pred_attacker(tuple_false)).
fof(ax268, axiom,
![VAR_V_51, VAR_V_52] : ((pred_attacker(VAR_V_51) & pred_attacker(VAR_V_52)) => pred_attacker(constr_enc(VAR_V_51, VAR_V_52)))).
fof(ax269, axiom,
![VAR_V_55, VAR_V_56] : ((pred_attacker(VAR_V_55) & pred_attacker(VAR_V_56)) => pred_attacker(constr_dec(VAR_V_55, VAR_V_56)))).
fof(ax270, axiom,
...
fof(ax276, axiom,
![VAR_V_59, VAR_V_60X30] : ((pred_attacker(VAR_V_59) & pred_attacker(VAR_V_60X30)) => pred_attacker(constr_checksign(VAR_V_59, VAR_V_60X30)))).
fof(ax277, axiom,
![VAR_V_63, VAR_V_64] : ((pred_attacker(VAR_V_63) & pred_attacker(VAR_V_64)) => pred_attacker(constr_aenc(VAR_V_63, VAR_V_64)))).
fof(ax278, axiom,
![VAR_V_67, VAR_V_68] : ((pred_attacker(VAR_V_67) & pred_attacker(VAR_V_68)) => pred_attacker(constr_adec(VAR_V_67, VAR_V_68)))).
fof(ax279, axiom,
...
fof(ax287, axiom,
![VAR_V_75, VAR_V_76] : ((pred_attacker(VAR_V_75) & pred_attacker(VAR_V_76)) => pred_attacker(tuple_2(VAR_V_75, VAR_V_76)))).
fof(ax288, axiom,
![VAR_V_83, VAR_V_84] : (pred_attacker(tuple_2(VAR_V_83, VAR_V_84)) => pred_attacker(VAR_V_83))).
fof(ax289, axiom,
![VAR_V_86, VAR_V_87] : (pred_attacker(tuple_2(VAR_V_86, VAR_V_87)) => pred_attacker(VAR_V_87))).
fof(ax290, axiom,
...
fof(ax304, axiom,
![VAR_0X40SID_247, VAR_SIGN_I_PKI_246] : ((pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_246, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_246)) => pred_attacker(tuple_2(constr_aenc(tuple_2(name_Na(VAR_0X40SID_247), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_246, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax305, axiom,
![VAR_0X40SID_30X302, VAR_AENC_NA_NI_30X301, VAR_SIGN_I_PKI_30X303] : ((pred_eq(constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_NI_30X301, name_skA)), name_Na(VAR_0X40SID_30X302)) & pred_attacker(VAR_AENC_NA_NI_30X301) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_30X303, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_30X303)) => pred_attacker(tuple_2(constr_aenc(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_NI_30X301, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_30X303, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax306, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax307, axiom,
![VAR_0X40SID_426, VAR_AENC_NA_A_424, VAR_SIGN_A_PKA_425] : ((pred_eq(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_424, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_424) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_425, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_425)) => pred_attacker(tuple_2(constr_aenc(tuple_2(constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_A_424, name_skB)), name_Nb(VAR_0X40SID_426)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_425, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax308, axiom,
![VAR_0X40SID_455, VAR_AENC_NA_A_456, VAR_AENC_NB_454, VAR_SIGN_A_PKA_457] : ((pred_eq(constr_adec(VAR_AENC_NB_454, name_skB), name_Nb(VAR_0X40SID_455)) & pred_attacker(VAR_AENC_NB_454) & pred_eq(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_456, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_456) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_457, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_457)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax309, axiom,
![VAR_DST_50X302, VAR_PKDST_50X303, VAR_SRC_50X304] : ((pred_table(tuple_keys(VAR_DST_50X302, VAR_PKDST_50X303)) & pred_attacker(tuple_2(VAR_SRC_50X304, VAR_DST_50X302))) => pred_attacker(tuple_2(constr_sign(tuple_2(VAR_DST_50X302, VAR_PKDST_50X303), name_skS), constr_key_retrieval_server_STEP_1)))).
fof(ax310, axiom,
![VAR_HOST_558, VAR_PK_559] : ((VAR_HOST_558 != name_B & VAR_HOST_558 != name_A & pred_attacker(tuple_2(VAR_HOST_558, VAR_PK_559))) => pred_table(tuple_keys(VAR_HOST_558, VAR_PK_559)))).
fof(co0, conjecture,
