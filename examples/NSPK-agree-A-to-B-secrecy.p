...
fof(ax304, axiom,
![VAR_0X40SID_248, VAR_SIGN_I_PKI_247] : ((pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_247, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_247)) => pred_attacker(tuple_2(constr_aenc(tuple_2(name_Na(VAR_0X40SID_248), name_A), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_247, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax305, axiom,
![VAR_0X40SID_30X303, VAR_AENC_NA_NI_30X302, VAR_SIGN_I_PKI_30X304] : ((pred_eq(constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_NI_30X302, name_skA)), name_Na(VAR_0X40SID_30X303)) & pred_attacker(VAR_AENC_NA_NI_30X302) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_30X304, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_30X304)) => pred_attacker(tuple_2(constr_aenc(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_NI_30X302, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_30X304, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax306, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax307, axiom,
![VAR_0X40SID_427, VAR_AENC_NA_A_425, VAR_SIGN_A_PKA_426] : ((pred_eq(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_425, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_425) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_426, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_426)) => pred_attacker(tuple_2(constr_aenc(tuple_2(constr_tuple_2_get_0x30(constr_adec(VAR_AENC_NA_A_425, name_skB)), name_Nb(VAR_0X40SID_427)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_426, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax308, axiom,
![VAR_0X40SID_456, VAR_AENC_NA_A_457, VAR_AENC_NB_455, VAR_SIGN_A_PKA_458] : ((pred_eq(constr_adec(VAR_AENC_NB_455, name_skB), name_Nb(VAR_0X40SID_456)) & pred_attacker(VAR_AENC_NB_455) & pred_eq(constr_tuple_2_get_1(constr_adec(VAR_AENC_NA_A_457, name_skB)), name_A) & pred_attacker(VAR_AENC_NA_A_457) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_458, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_458)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax309, axiom,
