...
fof(ax331, axiom,
![VAR_0X40SID_393, VAR_SIGN_I_PKI_392] : ((pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_392, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_392)) => pred_attacker(tuple_2(constr_ecb_enc_2(name_Na(VAR_0X40SID_393), name_A, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_392, constr_pkey(name_skS)))), constr_client_A_STEP_2)))).
fof(ax332, axiom,
![VAR_0X40SID_464, VAR_ECB_ENC_NA_NI_I_463, VAR_SIGN_I_PKI_465] : ((pred_eq(constr_tuple_3_get_2(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA)), name_I) & pred_eq(constr_tuple_3_get_0x30(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA)), name_Na(VAR_0X40SID_464)) & pred_attacker(VAR_ECB_ENC_NA_NI_I_463) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_I_PKI_465, constr_pkey(name_skS))), name_I) & pred_attacker(VAR_SIGN_I_PKI_465)) => pred_attacker(tuple_2(constr_ecb_enc_1(constr_tuple_3_get_1(constr_ecb_dec_3(VAR_ECB_ENC_NA_NI_I_463, name_skA)), constr_tuple_2_get_1(constr_checksign(VAR_SIGN_I_PKI_465, constr_pkey(name_skS)))), constr_client_A_STEP_3)))).
fof(ax333, axiom,
pred_attacker(tuple_2(tuple_2(name_B, name_A), constr_client_B_STEP_1))).
fof(ax334, axiom,
![VAR_0X40SID_590X30, VAR_ECB_ENC_NA_A_588, VAR_SIGN_A_PKA_589] : ((pred_eq(constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_588, name_skB)), name_A) & pred_attacker(VAR_ECB_ENC_NA_A_588) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_589, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_589)) => pred_attacker(tuple_2(constr_ecb_enc_3(constr_tuple_2_get_0x30(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_588, name_skB)), name_Nb(VAR_0X40SID_590X30), name_B, constr_tuple_2_get_1(constr_checksign(VAR_SIGN_A_PKA_589, constr_pkey(name_skS)))), constr_client_B_STEP_2)))).
fof(ax335, axiom,
![VAR_0X40SID_627, VAR_ECB_ENC_NA_A_628, VAR_ECB_ENC_NB_626, VAR_SIGN_A_PKA_629] : ((pred_eq(constr_ecb_dec_1(VAR_ECB_ENC_NB_626, name_skB), name_Nb(VAR_0X40SID_627)) & pred_attacker(VAR_ECB_ENC_NB_626) & pred_eq(constr_tuple_2_get_1(constr_ecb_dec_2(VAR_ECB_ENC_NA_A_628, name_skB)), name_A) & pred_attacker(VAR_ECB_ENC_NA_A_628) & pred_eq(constr_tuple_2_get_0x30(constr_checksign(VAR_SIGN_A_PKA_629, constr_pkey(name_skS))), name_A) & pred_attacker(VAR_SIGN_A_PKA_629)) => pred_attacker(tuple_2(name_objective, constr_client_B_STEP_3)))).
fof(ax336, axiom,
